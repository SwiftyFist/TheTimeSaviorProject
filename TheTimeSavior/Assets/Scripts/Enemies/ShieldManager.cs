...
{
    public float limSupAttivazioneScudiLaterali = 0.50f; //limite superiore per l attivazione degli scudi laterali
    public float limInfAttivazioneScudiLaterali = -0.50f; //limite inferiore per l attivazione degli scudi laterali
